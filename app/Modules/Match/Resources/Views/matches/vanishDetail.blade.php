                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-bordered panel-dark border border-dark">
                        ...
                        <div class="p-5">
                                ...
                                <div class="tab-content pt-20">
                                    ...
                                    <div class="tab-pane" id="bets" role="tabpanel">
                                        ...
                                        <table class="table table-bordered table-responsive-md table-responsive-sm">
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="11"><h5 class="text-danger text-center">No bet found</h5></td>
                                                </tr>
                                            @endif
                                            </tbody>
                                        </table>
                            ...
                            <div class="p-5">
                                <form action="{{ route("match_details_vanish_action",["id"=>$match->id]) }}" method="POST" id="matchesDetails" autocomplete="off">
                                    @csrf
                                            ...
                                            <div class="form-group">
                                                <div class="input-group input-group-icon">
                                                    ...
                                                    <select class="form-control" id="status" name="status">
                                                        ...
                                                        <option class="text-success font-weight-bold" value="3" @if($match['status'] == 3) selected="selected" @endif>Match Yet Live Vanish</option>
                                                        @endif
                                                        <option class="text-danger font-weight-bold" value="5" @if($match['status'] == 5) selected="selected" @endif>Match Vanish</option>
                                                    </select>
                                                </div>
                                            </div>
